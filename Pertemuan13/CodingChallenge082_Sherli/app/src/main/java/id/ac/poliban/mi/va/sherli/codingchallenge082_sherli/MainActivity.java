package id.ac.poliban.mi.va.sherli.codingchallenge082_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("StandUp! CodingChallenge08.2 Sherli");
