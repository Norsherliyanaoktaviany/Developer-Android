package id.ac.poliban.mi.va.sherli.droidcafeinput_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.va.sherli.droidcafeinput_sherli.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Droid Cafe Input_Sherli");
