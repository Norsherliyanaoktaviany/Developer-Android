package id.ac.poliban.mi.va.sherli.homework101b_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.va.sherli.homework101b_sherli";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types_Homework10.1b Sherli");
