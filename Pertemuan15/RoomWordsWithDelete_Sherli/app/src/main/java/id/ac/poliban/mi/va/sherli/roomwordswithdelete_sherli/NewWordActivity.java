package id.ac.poliban.mi.va.sherli.roomwordswithdelete_sherli;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.va.sherli.roomwordssampledelete_sherli.REPLY";
