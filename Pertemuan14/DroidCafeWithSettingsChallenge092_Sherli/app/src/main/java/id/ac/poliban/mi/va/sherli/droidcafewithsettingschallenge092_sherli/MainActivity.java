package id.ac.poliban.mi.va.sherli.droidcafewithsettingschallenge092_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.va.sherli.droidcafewithsettingschallenge092_sherli.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe Challenge09.2 Sherli");
