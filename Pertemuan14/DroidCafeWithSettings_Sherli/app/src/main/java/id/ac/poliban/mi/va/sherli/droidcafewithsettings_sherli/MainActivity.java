package id.ac.poliban.mi.va.sherli.droidcafewithsettings_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.va.sherli.droidcafewithsettings_sherli.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe With Settings_Sherli");
