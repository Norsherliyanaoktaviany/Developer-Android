package id.ac.poliban.mi.va.sherli.hellosharedprefs_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.va.sherli.hellosharedprefs_sherli";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("HelloSharedPrefs Sherli");
