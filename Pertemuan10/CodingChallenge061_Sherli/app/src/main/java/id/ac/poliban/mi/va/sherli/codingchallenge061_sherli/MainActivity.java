package id.ac.poliban.mi.va.sherli.codingchallenge061_sherli;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("RecyclerView Espresso Challenge061 Sherli");
